...
export const pages: Page[] = [
  ...
  { path: "/search-v2/:slug", component: PageSearchV2 },
  ...
  { path: "/edit-post/:slug", component: DashboardEditPost },
...
const privateRoutes = ["/dashboard", "/edit-post/:slug"];
      ...
      <Switch>
        {pages.map(({ component, path, exact }) => {
          if (privateRoutes.includes(path)) {
            return (<AuthenticatedRoute key={ncNanoId()} exact={exact} path={path} component={component} />);
          }
          else {
            return (<UnAuthenticatedRoute key={ncNanoId()} exact={exact} path={path} component={component} />);
          }
        })}
